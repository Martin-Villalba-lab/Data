...
\subsection{Filter unspecific binders in {{n}}}
Create an output directory.
<<RiboTagFilterUnspec{{n}}dir>>=
n = "{{n}}"
...
<<RiboTagFilterUnspecFigDir{{n}},include=FALSE>>=
opts_chunk$set(fig.path=file.path(d,""))
@

A DESeq dataset is created that contains the respective samples.

<<RiboTagFilterUnspec{{n}}matrix,resize.width="0.32\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
...
<<RiboTagTranslationEfficiency{{n}}counts,resize.width="0.6\\textwidth",fig.show='hold',fig.width=7*4,fig.height=7*4,dev='png'>>=
...
%' 
%' <<RiboTagFilterUnspec{{n}}kmeans,resize.width="0.47\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
...
%' <<RiboTagFilterUnspec{{n}}density,resize.width="0.47\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
...
<<RiboTagTranslationEfficiency{{n}}sizefactors,resize.width="0.32\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
...
<<RiboTagTranslationEfficiency{{n}}FilterUnspecific,resize.width="0.32\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
D = C
m = log2(s)
for (i in 1:ncol(EC)) {
  D[,i] = D[,i] - m[i]
...
<<RiboTagTranslationEfficiency{{n}}model,resize.width="0.32\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
fit1 = list()
for (i in 1:2) {
...
<<RiboTagTranslationEfficiency{{n}}ExpVar,resize.width="0.32\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
...
<<RiboTagTranslationEfficiency{{n}}addNames,resize.width="0.47\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
...
<<RiboTagTranslationEfficiency{{n}}filterHighSigma,resize.width="0.32\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
...
<<RiboTagTranslationEfficiency{{n}}MAplot,resize.width="0.32\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
...
<<RiboTagTranslationEfficiency{{n}}save,resize.width="0.47\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
...
<<RiboTagTranslationEfficiency{{n}}countsUnspec,resize.width="0.6\\textwidth",fig.show='hold',fig.width=7*4,fig.height=7*4,dev='png'>>=
...
<<RiboTagTranslationEfficiency{{n}}countsHits,resize.width="0.6\\textwidth",fig.show='hold',fig.width=7*4,fig.height=7*4,dev='png'>>=
...
<<RiboTagTranslationEfficiency{{n}}GSEA,resize.width="0.47\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
...
<<RiboTagTranslationEfficiency{{n}}GSEAreport, echo=FALSE, results='hide'>>=
...
<<RiboTagTranslationEfficiency{{n}}table>>=
...
<<RiboTagTranslationEfficiency{{n}}webpage,echo=FALSE,results='hide'>>=
