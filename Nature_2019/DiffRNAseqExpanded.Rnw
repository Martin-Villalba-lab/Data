...
\subsection{Differential gene expression in ENB-NSC}
Create an output directory.
<<RiboTagDiffExprRNAseqENB-NSCdir>>=
n = "ENB-NSC"
type="RNAseq"
...
<<RiboTagDiffExprRNAseqENB-NSCmatrix,resize.width="0.32\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
...
<<RiboTagDiffExprRNAseqENB-NSCcounts,resize.width="0.6\\textwidth",fig.show='hold',fig.width=7*4,fig.height=7*4,dev='png'>>=
C = counts(dds)
C = log2(C+1)
...
<<RiboTagDiffExprRNAseqENB-NSCDESeq,resize.width="0.32\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
dds = DESeq(dds)
res = results(dds)
@
...
%' 
%' <<RiboTagDiffExprRNAseqENB-NSCPCA,fig.width=7,fig.height=7>>=
...
<<RiboTagDiffExprRNAseqENB-NSCsizefactors,resize.width="0.32\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
...
<<RiboTagDiffExprRNAseqENB-NSCMAplot,resize.width="0.47\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
plotMA(res, ylim=c(-5,5), ylab=sprintf("log fold change (%s)",n), main=n)
@

<<RiboTagDiffExprRNAseqENB-NSCaddNames,resize.width="0.47\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
...
The data is saved.
<<RiboTagDiffExprRNAseqENB-NSCsave,resize.width="0.47\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
save(dds, file=file.path(d, "dds.rda"))
save(res, file=file.path(d, "res.rda"))
@

<<RiboTagDiffExprRNAseqENB-NSCcountsHits,resize.width="0.6\\textwidth",fig.show='hold',fig.width=7*4,fig.height=7*4,dev='png'>>=
...
<<RiboTagDiffExprRNAseqENB-NSCGSEA,resize.width="0.47\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
...
<<RiboTagDiffExprRNAseqENB-NSCGSEAreport, echo=FALSE, results='hide'>>=
...
<<RiboTagDiffExprRNAseqENB-NSCtable>>=
...
<<RiboTagDiffExprRNAseqENB-NSCwebpage,echo=FALSE,results='hide'>>=
...
\subsection{Differential gene expression in LNB-ENB}
Create an output directory.
<<RiboTagDiffExprRNAseqLNB-ENBdir>>=
n = "LNB-ENB"
type="RNAseq"
Samples = SamplesRNAseq
filter = "none"
...
<<RiboTagDiffExprRNAseqFigDirLNB-ENB,include=FALSE>>=
opts_chunk$set(fig.path=file.path(d,""))
@

The count matrix is copied for convenience.
<<RiboTagDiffExprRNAseqFilterMatrixLNB-ENB>>=
X = rawCounts[,Samples[[n]]]
Design = DesignRNAseq
@

%' The count data is filtered by replacing some rows by 0.
%' <<RiboTagDiffExprRNAseqFilterLNB-ENB>>=
%' if (filter == "none") {
%'   outputfilter = "No filtering applied."
%'   print(outputfilter)
%' } else {
...
<<RiboTagDiffExprRNAseqLNB-ENBmatrix,resize.width="0.32\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
dds <- DESeqDataSetFromMatrix(countData = X,
                              colData = SampleList[Samples[[n]],],
                              design = Design[[n]])
colData(dds)
...
Log counts are computed and plotted as a pairs plot.
<<RiboTagDiffExprRNAseqLNB-ENBcounts,resize.width="0.6\\textwidth",fig.show='hold',fig.width=7*4,fig.height=7*4,dev='png'>>=
C = counts(dds)
C = log2(C+1)
lim = range(as.vector(C))
pairs(C,pch=20,cex=0.5,xlim=lim, ylim=lim,col="#00000022")
...
<<RiboTagDiffExprRNAseqLNB-ENBDESeq,resize.width="0.32\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
dds = DESeq(dds)
res = results(dds)
@
...
%' A PCA plot is generated for exploratory analysis.
%' 
%' <<RiboTagDiffExprRNAseqLNB-ENBPCA,fig.width=7,fig.height=7>>=
%' rld <- rlog(dds, blind=FALSE)
%' plotPCA(rld, intgroup = "sample")
%' @
...
<<RiboTagDiffExprRNAseqLNB-ENBsizefactors,resize.width="0.32\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
p = par(mar=c(10,4,4,2)+0.1)
barplot(sizeFactors(dds), main="estimates size factors",las=2)
par(p)
@
...
An MA plot shows in red the genes that are enriched by the RiboTag pull-down. For comparison, the second plot shows the genes that were used to estimate the size factors.
<<RiboTagDiffExprRNAseqLNB-ENBMAplot,resize.width="0.47\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
plotMA(res, ylim=c(-5,5), ylab=sprintf("log fold change (%s)",n), main=n)
@

<<RiboTagDiffExprRNAseqLNB-ENBaddNames,resize.width="0.47\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
load(file.path("data","ENSGannotation.rda"))
res$symbol = ENSGannotation[row.names(res),"name"]
res$symbol[is.na(res$symbol)] = row.names(res)[is.na(res$symbol)]
...
The data is saved.
<<RiboTagDiffExprRNAseqLNB-ENBsave,resize.width="0.47\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
save(dds, file=file.path(d, "dds.rda"))
save(res, file=file.path(d, "res.rda"))
@

<<RiboTagDiffExprRNAseqLNB-ENBcountsHits,resize.width="0.6\\textwidth",fig.show='hold',fig.width=7*4,fig.height=7*4,dev='png'>>=
col=rep("#00000022", nrow(res))
col[which(res$padj <= 0.1 & res$log2FoldChange > 0)] = brewer.pal(4,"RdBu")[2]
col[which(res$padj <= 0.1 & res$log2FoldChange < 0)] = brewer.pal(4,"RdBu")[3]
col[which(res$padj <= 0.01 & res$log2FoldChange > 0)] = brewer.pal(4,"RdBu")[1]
...
<<RiboTagDiffExprRNAseqLNB-ENBGSEA,resize.width="0.47\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
fgup = row.names(res)[which(res$significant != "" & res$log2FoldChange > 0)]
fgdown = row.names(res)[which(res$significant != "" & res$log2FoldChange < 0)]
bg = row.names(res)[which(!is.na(res$padj))]
GSEAup = doGSEA(fgup,bg,ENSG2category, k=3)
...
<<RiboTagDiffExprRNAseqLNB-ENBGSEAreport, echo=FALSE, results='hide'>>=
hwriteGSEAreport(GSEAup, d = file.path(d, "GSEAup"),
                 ENSGannotation=ENSGannotation, 
                 title = sprintf("Gene set enrichment analysis (%s, %s up-regulated genes)",n,type),
                 prefix = "rnaUp-")
...
<<RiboTagDiffExprRNAseqLNB-ENBtable>>=
write.table(res, file=file.path(d, "resulttable.txt"), sep="\t", quote=FALSE)
page = openPage(file.path(d,"resulttable.html"), link.css="hwriter.css")
hwriteSidebar(page=page, link=mainmenu)
hwrite(sprintf("Differential gene expression (%s;%s); result table",type,n), 
...
<<RiboTagDiffExprRNAseqLNB-ENBwebpage,echo=FALSE,results='hide'>>=
file.copy(system.file("images","hwriter.css", package="hwriter"),
          file.path(d, "hwriter.css"))
page = openPage(file.path(d, "index.html"), link.css="hwriter.css")
hwriteSidebar(page=page, link=mainmenu)
...
\subsection{Differential gene expression in NEURON-LNB}
Create an output directory.
<<RiboTagDiffExprRNAseqNEURON-LNBdir>>=
n = "NEURON-LNB"
type="RNAseq"
Samples = SamplesRNAseq
filter = "none"
...
<<RiboTagDiffExprRNAseqFigDirNEURON-LNB,include=FALSE>>=
opts_chunk$set(fig.path=file.path(d,""))
@

The count matrix is copied for convenience.
<<RiboTagDiffExprRNAseqFilterMatrixNEURON-LNB>>=
X = rawCounts[,Samples[[n]]]
Design = DesignRNAseq
@

%' The count data is filtered by replacing some rows by 0.
%' <<RiboTagDiffExprRNAseqFilterNEURON-LNB>>=
%' if (filter == "none") {
%'   outputfilter = "No filtering applied."
%'   print(outputfilter)
%' } else {
...
<<RiboTagDiffExprRNAseqNEURON-LNBmatrix,resize.width="0.32\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
dds <- DESeqDataSetFromMatrix(countData = X,
                              colData = SampleList[Samples[[n]],],
                              design = Design[[n]])
colData(dds)
...
Log counts are computed and plotted as a pairs plot.
<<RiboTagDiffExprRNAseqNEURON-LNBcounts,resize.width="0.6\\textwidth",fig.show='hold',fig.width=7*4,fig.height=7*4,dev='png'>>=
C = counts(dds)
C = log2(C+1)
lim = range(as.vector(C))
pairs(C,pch=20,cex=0.5,xlim=lim, ylim=lim,col="#00000022")
...
<<RiboTagDiffExprRNAseqNEURON-LNBDESeq,resize.width="0.32\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
dds = DESeq(dds)
res = results(dds)
@
...
%' A PCA plot is generated for exploratory analysis.
%' 
%' <<RiboTagDiffExprRNAseqNEURON-LNBPCA,fig.width=7,fig.height=7>>=
%' rld <- rlog(dds, blind=FALSE)
%' plotPCA(rld, intgroup = "sample")
%' @
...
<<RiboTagDiffExprRNAseqNEURON-LNBsizefactors,resize.width="0.32\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
p = par(mar=c(10,4,4,2)+0.1)
barplot(sizeFactors(dds), main="estimates size factors",las=2)
par(p)
@
...
An MA plot shows in red the genes that are enriched by the RiboTag pull-down. For comparison, the second plot shows the genes that were used to estimate the size factors.
<<RiboTagDiffExprRNAseqNEURON-LNBMAplot,resize.width="0.47\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
plotMA(res, ylim=c(-5,5), ylab=sprintf("log fold change (%s)",n), main=n)
@

<<RiboTagDiffExprRNAseqNEURON-LNBaddNames,resize.width="0.47\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
load(file.path("data","ENSGannotation.rda"))
res$symbol = ENSGannotation[row.names(res),"name"]
res$symbol[is.na(res$symbol)] = row.names(res)[is.na(res$symbol)]
...
The data is saved.
<<RiboTagDiffExprRNAseqNEURON-LNBsave,resize.width="0.47\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
save(dds, file=file.path(d, "dds.rda"))
save(res, file=file.path(d, "res.rda"))
@

<<RiboTagDiffExprRNAseqNEURON-LNBcountsHits,resize.width="0.6\\textwidth",fig.show='hold',fig.width=7*4,fig.height=7*4,dev='png'>>=
col=rep("#00000022", nrow(res))
col[which(res$padj <= 0.1 & res$log2FoldChange > 0)] = brewer.pal(4,"RdBu")[2]
col[which(res$padj <= 0.1 & res$log2FoldChange < 0)] = brewer.pal(4,"RdBu")[3]
col[which(res$padj <= 0.01 & res$log2FoldChange > 0)] = brewer.pal(4,"RdBu")[1]
...
<<RiboTagDiffExprRNAseqNEURON-LNBGSEA,resize.width="0.47\\textwidth",fig.show='hold',fig.width=5,fig.height=5>>=
fgup = row.names(res)[which(res$significant != "" & res$log2FoldChange > 0)]
fgdown = row.names(res)[which(res$significant != "" & res$log2FoldChange < 0)]
bg = row.names(res)[which(!is.na(res$padj))]
GSEAup = doGSEA(fgup,bg,ENSG2category, k=3)
...
<<RiboTagDiffExprRNAseqNEURON-LNBGSEAreport, echo=FALSE, results='hide'>>=
hwriteGSEAreport(GSEAup, d = file.path(d, "GSEAup"),
                 ENSGannotation=ENSGannotation, 
                 title = sprintf("Gene set enrichment analysis (%s, %s up-regulated genes)",n,type),
                 prefix = "rnaUp-")
...
<<RiboTagDiffExprRNAseqNEURON-LNBtable>>=
write.table(res, file=file.path(d, "resulttable.txt"), sep="\t", quote=FALSE)
page = openPage(file.path(d,"resulttable.html"), link.css="hwriter.css")
hwriteSidebar(page=page, link=mainmenu)
hwrite(sprintf("Differential gene expression (%s;%s); result table",type,n), 
...
<<RiboTagDiffExprRNAseqNEURON-LNBwebpage,echo=FALSE,results='hide'>>=
file.copy(system.file("images","hwriter.css", package="hwriter"),
          file.path(d, "hwriter.css"))
page = openPage(file.path(d, "index.html"), link.css="hwriter.css")
hwriteSidebar(page=page, link=mainmenu)
